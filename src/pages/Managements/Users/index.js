    ...
    onHandleSearchUser = (req) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                axios.get('/user/search', { params: values })
                    .then((res) => {
        ...
        return (
            <Collapse defaultActiveKey={['2']} >
                    ...
                    <Form className="ant-advanced-search-panel ">
                        <Grid>
                            <Row className="show-grid">
                                <Col md={6} sm={12} xs={6} style={{ textAlign: 'left' }}>
                                    <FormItem label={'USERNAME'}>
                                        {
                                            getFieldDecorator('username', {})(<Input type='text' placeholder="username" />)
                                        }
                                    </FormItem>
                                </Col>
                                <Col md={6} sm={12} xs={6} style={{ textAlign: 'left' }}>
                            ...
                            <div className="ant-advanced-toolbar">
                                <Button type="primary" value='new' className='ant-advanced-toolbar-item' onClick={this.onHandleSearchUser} >SEARCH</Button>
                                <Button style={{ marginLeft: 8 }} type="primary" value='view' className='ant-advanced-toolbar-item' >CLEAR</Button>
                            </div>
                        </Grid>
                    </Form>
                </Panel>
                <Panel header="USERS" key="2">
                    ...
                    <div className="ant-advanced-toolbar">
                        <Button type="primary" value='new' className='ant-advanced-toolbar-item' >NEW</Button>
                        <Button style={{ marginLeft: 8 }} type="primary" value='view' className='ant-advanced-toolbar-item' >DETAIL</Button>
                    </div>
                    <ReactDataGrid
